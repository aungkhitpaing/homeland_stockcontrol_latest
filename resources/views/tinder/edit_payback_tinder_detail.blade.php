                            ...
                            <section class="content">
                                <div class="row">
                                    ...
                                    @foreach ($getData as $data)
                                        <!-- form start -->
                                            <form class="form-horizontal" method="POST" action="/head_quater/tinder_registeration/payback/{{$data->id}}/update">
                                                {{ csrf_field() }}
                                                {{ method_field('PATCH') }}
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control" name="account_head"  required>
                                                                <option  value="{{$data->account_head}}">{{$data->account_head_type}}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text"  class="form-control" id="" name="register_name" value="{{$data->register_name}}" placeholder="Register name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" id="inputamount" class="form-control"  value="{{$data->register_amount}}" name="register_amount">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">$</span>
                                                                <input type="number" id="inputamount" class="form-control" disabled value="{{$data->payback_amount}}" name="payback_amount">
                                                                <span class="input-group-addon">Kyats</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="input-group date">
                                                                ...
                                                                <input type="text" class="form-control pull-right" id="pg_with_draw" value="{{$data->register_date}}"  name="register_date">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
